  ...
  return (
    <div className="space-y-6 animate-fade-in-up">
      <div className="flex items-center justify-between border-b border-border/10 pb-4">
        <div>
          <h1 className="text-3xl font-bold font-serif text-text-primary tracking-tight">Credential Providers</h1>
          <p className="text-xs text-text-secondary mt-1 leading-relaxed font-medium">Manage Coinbase CDP and Stripe/Privy credential providers</p>
        </div>
