  ...
  return (
    <div className="space-y-6 animate-fade-in-up">
      <div className="flex items-center justify-between border-b border-border/10 pb-4">
        <div>
          <h1 className="text-3xl font-bold font-serif text-text-primary tracking-tight">My Sessions</h1>
          <p className="text-xs text-text-secondary mt-1 leading-relaxed font-medium">Payment sessions with spend budgets</p>
        </div>
